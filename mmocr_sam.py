...
def parse_args():
    ...
    parser.add_argument(
        "--inputs",
        type=str,
        default="/media/jiangqing/jqssd/projects/research/UniText/datasets/TextSeg_Ori/train/ori_img",
        help="Input image file or folder path.",
    )
    parser.add_argument(
        "--outdir", type=str, default="results/", help="Output directory of results."
    )
    # MMOCR parser
    parser.add_argument(
        "--det",
        type=str,
        default="mmocr_dev/configs/textdet/dbnetpp/dbnetpp_swinv2_base_w16_in21k.py",
    ...
    parser.add_argument(
        ...
        type=str,
        # required=True,
        default="checkpoints/mmocr/abinet_20e_st-an_mj_20221005_012617-ead8c139.pth",
    ...
    parser.add_argument(
        "--sam_type", type=str, default="vit_h", help="path to checkpoint file"
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    mmocr_inferencer = MMOCRInferencer(
        args.det, args.det_weights, args.rec, args.rec_weights, device=args.device
    )
    # Build SAM
    ...
    for i, ori_input in enumerate(ori_inputs):
        ...
        # MMOCR inference
        result = mmocr_inferencer(img, save_vis=True, out_dir=args.outdir)[
            "predictions"
        ][0]
